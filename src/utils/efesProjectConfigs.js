...
function findAllEfesConfigs(spaceDirname) {
  ...
  return lookup(spaceDirname, regExcludes, regIncludes)
}
...
// 获取请求路径所匹配的项目配置文件
exports.getProjectConfig = function getProjectConfig(requestHost, requestPath, spaceInfo, spaceDirname, spaceProjectConfigs) {
