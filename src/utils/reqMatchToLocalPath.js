...
function doMatch(requestPath, projectConfigs, workSpaceDirname) {
  let _matchedPathConfigs = [];

  projectConfigs && projectConfigs.some(function(projectConfig){
    let matchedPathConfig = {
      root: path.join(workSpaceDirname, projectConfig.rewrite.root),
...
exports.match = function match(requestHost, requestPath, projectConfigs, workSpaceDirname) {
